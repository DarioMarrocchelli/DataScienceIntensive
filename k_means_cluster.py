...
for person in data_dict:
    if str(data_dict[person]['salary']) != 'NaN':
        stock.append(float(data_dict[person]['salary']))
        #print(data_dict[person]['exercised_stock_options'])
        
print(min(stock), max(stock))
print(type(stock[0]))
...
clf = KMeans(n_clusters=3, n_init = 20)
